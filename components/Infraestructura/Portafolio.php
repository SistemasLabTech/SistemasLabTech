<div id="portfolio" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p class="lead">Con una superficie de 58,269 m2 dividida en 17,678 m2 de bodegas techadas y 40,591 m2 de patio, Maniobras Estratégicas del Pacifico se localiza a tan solo 2 km. Del puerto de Manzanillo, contando con una excelente ubicación para sus operaciones dentro y fuera del puerto.</p>
            </div><!-- end title -->
        </div><!-- end container -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="portfolio-filter text-center">
                        <ul>
                            <li><a class="btn btn-dark btn-radius btn-brd active" href="#" data-filter="*"><span class="oi hidden-xs" data-glyph="grid-three-up"></span> Todos</a></li>
                            <li><a class="btn btn-dark btn-radius btn-brd" data-toggle="tooltip" data-placement="top" title="5" href="#" data-filter=".cat1">Oficinas</a></li>
                            <li><a class="btn btn-dark btn-radius btn-brd" href="#" data-toggle="tooltip" data-placement="top" title="12" data-filter=".cat2">Patios</a></li>
                            <li><a class="btn btn-dark btn-radius btn-brd" href="#" data-toggle="tooltip" data-placement="top" title="21" data-filter=".cat3">Seguridad</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
